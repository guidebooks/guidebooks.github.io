/*!**************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-client-common/web/scss/components/Navigation/Patternfly.scss ***!
  \**************************************************************************************************************************************************************************************/
/*
...
body[kui-theme-style] .kui--scrollback[data-is-width-constrained] .kui--sidecar-nested[data-view=leftnav] .pf-c-nav {
  max-width: 15em;
}
body[kui-theme-style] .kui--sidecar .pf-c-nav {
  --pf-c-nav__list-toggle--FontSize: 1em;
  width: auto;
  background-color: var(--color-sidecar-header);
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list {
  /** 
...
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list section[hidden] {
  display: none;
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list a:hover:not(.plain-anchor) {
  color: unset;
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__item.pf-m-expandable::before {
  border-bottom-color: var(--pf-global--BackgroundColor--dark-400);
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__item .pf-c-nav__list .pf-c-nav__link {
  display: block;
  white-space: nowrap;
  overflow: hidden;
...
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__link:not(.kui--mode-placeholder) {
  padding-left: 1em;
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__link {
  color: var(--pf-global--Color);
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__link.pf-c-nav__link.pf-m-current {
  background-color: var(--pf-global--BackgroundColor--dark-100);
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__link:hover {
  cursor: pointer;
  background-color: var(--pf-global--BackgroundColor--dark-400);
}
body[kui-theme-style] .kui--sidecar .pf-c-nav .pf-c-nav__list .pf-c-nav__subnav {
  padding-left: 1em;
}
