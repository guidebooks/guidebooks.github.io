/*!****************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-patternfly4-themes/web/scss/patternfly4-light.scss ***!
  \****************************************************************************************************************************************************************************/
/*
 ...
 * limitations under the License.
 */
/** The top-level TabContainer component */
/** The <main/> under the TabContainer component. THis encloses just the content (no header, no sidebar, etc.) */
/*
 * Copyright 2020 The Kubernetes Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
@font-face {
  ...
  src: url(./419c2e1d15a717045aff.woff2) format("woff2");
  font-style: italic;
  font-weight: 400;
...
@font-face {
  font-family: "RedHatText";
  src: url(./4a43a00f1c0c63f396ee.woff2) format("woff2");
  font-style: normal;
  font-weight: 400;
  text-rendering: optimizeLegibility;
}
@font-face {
  font-family: "RedHatText";
  src: url(./0227c8bb038eaf0264f7.woff2) format("woff2");
  font-style: normal;
  font-weight: 500;
  text-rendering: optimizeLegibility;
}
@font-face {
  font-family: "RedHatText";
  src: url(./f8f001590eaec153b9c6.woff2) format("woff2");
  font-style: normal;
  font-weight: 700;
  text-rendering: optimizeLegibility;
}
@font-face {
  ...
  src: url(./f4418bd9e2b289caffbd.woff2) format("woff2");
  font-style: italic;
  font-weight: 400;
  text-rendering: optimizeLegibility;
}
@font-face {
  font-family: "RedHatDisplay";
  src: url(./4e58e730f447f9d6a422.woff2) format("woff2");
  font-style: normal;
  font-weight: 400;
  text-rendering: optimizeLegibility;
}
@font-face {
  font-family: "RedHatDisplay";
  src: url(./09bac349bc9aa9b72bbe.woff2) format("woff2");
  font-style: normal;
  font-weight: 500;
  text-rendering: optimizeLegibility;
}
@font-face {
  font-family: "RedHatDisplay";
  src: url(./7b7bb91c0af148738090.woff2) format("woff2");
  font-style: normal;
  font-weight: 700;
  text-rendering: optimizeLegibility;
}
...
body {
  ...
  --pf-global--spacer--xs: calc(var(--kui--font-factor) * 0.25rem);
  --pf-global--spacer--sm: calc(var(--kui--font-factor) * 0.5rem);
  --pf-global--spacer--md: calc(var(--kui--font-factor) * 1rem);
  --pf-global--spacer--lg: calc(var(--kui--font-factor) * 1.5rem);
  --pf-global--spacer--xl: calc(var(--kui--font-factor) * 2rem);
  --pf-global--spacer--2xl: calc(var(--kui--font-factor) * 3rem);
  --pf-global--spacer--3xl: calc(var(--kui--font-factor) * 4rem);
  --pf-global--spacer--4xl: calc(var(--kui--font-factor) * 5rem);
  --pf-global--spacer--form-element: calc(var(--kui--font-factor) * 0.375rem);
  --pf-global--gutter: calc(var(--kui--font-factor) * 1rem);
  --pf-global--gutter--md: calc(var(--kui--font-factor) * 1.5rem);
  ...
  --pf-global--icon--FontSize--sm: calc(var(--kui--font-factor) * 0.625rem);
  --pf-global--icon--FontSize--md: calc(var(--kui--font-factor) * 1.125rem);
  --pf-global--icon--FontSize--lg: calc(var(--kui--font-factor) * 1.5rem);
  --pf-global--icon--FontSize--xl: calc(var(--kui--font-factor) * 3.375rem);
  --pf-global--FontSize--4xl: calc(var(--kui--font-factor) * 2.25rem);
  --pf-global--FontSize--3xl: calc(var(--kui--font-factor) * 1.75rem);
  --pf-global--FontSize--2xl: calc(var(--kui--font-factor) * 1.5rem);
  --pf-global--FontSize--xl: calc(var(--kui--font-factor) * 1.25rem);
  --pf-global--FontSize--lg: calc(var(--kui--font-factor) * 1.125rem);
  --pf-global--FontSize--md: calc(var(--kui--font-factor) * 1rem);
  --pf-global--FontSize--sm: calc(var(--kui--font-factor) * 0.875rem);
  --pf-global--FontSize--xs: calc(var(--kui--font-factor) * 0.75rem);
...
body.kui--patternfly4[kui-theme-style] {
  ...
  --font-sans-serif: "RedHatText";
  --font-sans-serif-title: "RedHatDisplay";
  --color-dropdown: var(--pf-global--palette--black-200);
  --color-hover-primary-text: var(--pf-global--link--Color--light--hover);
  --color-primary-button-background: var(--pf-global--primary-color--100);
  --color-secondary-button-background: transparent;
  --color-primary-button-background-hover: var(--pf-global--primary-color--200);
  --color-secondary-button-border: 1px solid var(--pf-global--primary-color--100);
  --color-secondary-button-border-hover: 2px solid var(--pf-global--primary-color--100);
  /* attribution: @patternfly/react-core/dist/styles/base.css version 4.18.5; license MIT */
  --pf-global--palette--black-100: #fafafa;
  --pf-global--palette--black-150: #f5f5f5;
  --pf-global--palette--black-200: #f0f0f0;
  /* this is hsl(0deg,0%,94%) */
  --pf-global--palette--black-250-kui: hsl(0deg 0% 90%);
  ...
  --pf-global--palette--green-400-rgb: 91, 163, 82;
  --pf-global--palette--green-500: #3e8635;
  --pf-global--palette--green-500-rgb: 62, 134, 53;
  ...
  --pf-global--palette--red-100-rgb: 201, 25, 11;
 ...
 * limitations under the License.
 */
/* Wizard nav counter element (1) (2) etc. */
/*
 * Copyright 2020 The Kubernetes Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] {
  --color-base00: var(--pf-global--palette--black-100);
  --color-base01: var(--pf-global--palette--black-200);
  --color-base02: var(--pf-global--palette--black-300);
  --color-base03: var(--pf-global--palette--black-150);
  --color-base04: var(--pf-global--palette--black-600);
  --color-base05: var(--pf-global--palette--black-800);
  --color-base06: var(--pf-global--palette--black-900);
  --color-base07: var(--pf-global--palette--black-1000);
  --color-base08: var(--pf-global--palette--red-100);
  --color-base09: var(--pf-global--palette--gold-500);
  --color-base0A: var(--pf-global--palette--orange-500);
  --color-base0B: var(--pf-global--palette--green-500);
  --color-base0C: var(--pf-global--palette--light-blue-500);
  --color-base0D: var(--pf-global--palette--blue-400);
  --color-base0E: #d12765;
  --color-base0F: var(--pf-global--palette--purple-300);
  ...
  --color-stripe-01: var(--pf-global--palette--black-400);
  --color-repl-background: var(--pf-global--palette--white);
  --color-repl-background-02: var(--pf-global--palette--black-250-kui);
  ...
  --active-tab-color: var(--pf-global--active-color--100);
  ...
  /*  --color-latency-0: #0066cc;
  --color-latency-1: #4cb140;
  --color-latency-2: #009596;
  --color-latency-3: #5752d1;
  --color-latency-4: #f4c145;
  --color-latency-5: #ec7a08;
  --color-latency-6: #8b8d8f; */
  --color-latency-0: #002f5d;
  --color-latency-1: #519de9;
  --color-latency-2: rgb(139 193 247 / 0.25);
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .kui--dark-context {
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .kui--inverted-color-context {
  --color-base00: var(--pf-global--palette--black-850);
  --color-base01: var(--pf-global--palette--black-700);
  --color-base02: var(--pf-global--palette--black-800);
  --color-base03: var(--pf-global--palette--black-900);
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .kui--sidecar {
  ...
  --color-base0D: var(--pf-global--palette--blue-100);
  --color-base0E: #fa75a6;
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .kui--status-stripe[data-type=default] {
  --color-base00: var(--pf-global--palette--black-850);
  --color-base01: var(--pf-global--palette--black-700);
  --color-base02: var(--pf-global--palette--black-800);
  --color-base03: var(--pf-global--palette--black-900);
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .kui--commentary-editor {
  --color-base00: var(--pf-global--palette--black-850);
  --color-base01: var(--pf-global--palette--black-700);
  --color-base02: var(--pf-global--palette--black-800);
  --color-base03: var(--pf-global--palette--black-900);
...
body.kui--patternfly4[kui-theme="PatternFly4 Light"][kui-theme-style] .pf-c-wizard__header {
  --color-base00: var(--pf-global--palette--black-850);
  --color-base01: var(--pf-global--palette--black-700);
  --color-base02: var(--pf-global--palette--black-800);
  --color-base03: var(--pf-global--palette--black-900);
