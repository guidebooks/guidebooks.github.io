/*!*********************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-client-common/web/css/static/SidecarCommon.css ***!
  \*********************************************************************************************************************************/
/*
...
/*!***********************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-client-common/web/css/static/sidecar-main.css ***!
  \***********************************************************************************************************************************************************************/
/*
 * Copyright 2017 The Kubernetes Authors
 *
...
.kui--sidecar .sidecar-bottom-stripe {
  flex-basis: 2.5em;
  display: flex;
...
.kui--sidecar .sidecar-bottom-stripe-left-bits .sidecar-bottom-stripe-button-container.sidecar-bottom-stripe-back-bits.has-back-button {
  flex: initial;
  margin-right: 0;
  padding: 0 0.625em;
  /* the button inside has 0.375em padding left-right */
}
...
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text p {
  font-size: inherit;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text em {
  padding: 0.125em 1em;
  margin: 0 1.25em;
  font-style: normal;
...
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text {
  align-items: center;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text,
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-mode-bits {
...
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text svg path {
  fill: var(--color-sidecar-toolbar-foreground);
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text svg path[data-icon-path=inner-path] {
  fill: var(--color-text-01);
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text[data-type=warning] svg path {
  fill: var(--color-base0A);
  stroke: var(--color-base00);
  stroke-width: 4%;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text[data-type=warning] svg path[data-icon-path=inner-path],
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text[data-type=error] svg path[data-icon-path=inner-path] {
  fill: var(--color-white);
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text[data-type=error] svg path {
  fill: var(--color-error);
  stroke: var(--color-base00);
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text:not([data-type]),
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-mode-bits.sidecar-bottom-stripe-button-container:empty {
  display: none !important;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text:not([data-type]) + .sidecar-bottom-stripe-mode-bits.sidecar-bottom-stripe-button-container:not(:empty) {
  flex: 1;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text-icon {
  margin-right: 0.375em;
  padding-left: 1em;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text-icon > svg {
  display: none;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text[data-type] svg {
  display: block;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text .sidecar-toolbar-text-content {
  font-size: 0.75em;
  display: block;
...
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text .sidecar-toolbar-text-content p {
  overflow: hidden;
  text-overflow: ellipsis;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-button {
  padding: 3px;
  margin: 1px 0;
  display: flex;
  line-height: 1.5em;
...
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-button button[aria-label=Actions] {
  padding: 0;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-button [role=tab] {
  display: flex;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .graphical-icon svg {
  fill: var(--color-sidecar-toolbar-foreground);
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-bottom-stripe-mode-bits.sidecar-bottom-stripe-button-container {
  padding: 0 0.375em 0 1em;
  display: flex;
  flex: initial;
}
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text a,
body[kui-theme-style] .sidecar-bottom-stripe-toolbar .sidecar-toolbar-text a:hover {
...
.kui--sidecar .custom-content {
  ...
  flex: 1;
  min-height: 0;
  /* without this, in firefox wskflow pushes the bottom stripe off the bottom of the viewport */
}
...
.kui--sidecar .sidecar-header .header-left-bits {
  flex: 1;
}
.kui--sidecar .sidecar-header .header-right-bits {
  white-space: nowrap;
  margin-left: 1em;
  margin-right: 5px;
  /* matching titlebar */
}
.kui--sidecar .sidecar-header .header-right-bits .custom-header-content {
  display: flex;
  flex-direction: column;
  flex: 1;
...
.kui--sidecar .sidecar-header .sidecar-header-text {
  overflow: hidden;
  display: flex;
  flex-direction: column;
...
.sidecar-bottom-stripe .sidecar-bottom-stripe-right-bits,
.sidecar-bottom-stripe .sidecar-non-window-buttons,
.sidecar-bottom-stripe .sidecar-window-buttons {
  display: flex;
}
...
.sidecar-bottom-stripe .sidecar-bottom-stripe-button > div,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button a,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button button {
  padding: 3px;
  display: flex;
  color: var(--color-text-01);
}
.sidecar-bottom-stripe .sidecar-bottom-stripe-button > div svg,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button a svg,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button button svg {
  fill: currentColor;
}
.sidecar-bottom-stripe .sidecar-bottom-stripe-button button.disabled svg {
  fill: var(--color-text-02);
}
.sidecar-bottom-stripe .sidecar-bottom-stripe-button:not(.disabled):hover a,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button:not(.disabled):hover button {
  background-color: var(--color-table-border1);
}
.sidecar-bottom-stripe .sidecar-bottom-stripe-button:not(.disabled):hover a svg,
.sidecar-bottom-stripe .sidecar-bottom-stripe-button:not(.disabled):hover button svg {
  fill: currentColor;
}
...
.kui--sidecar--titlebar-navigation:not(:empty) .sidecar-bottom-stripe-button:nth-child(2) {
  margin-right: 1em;
}
