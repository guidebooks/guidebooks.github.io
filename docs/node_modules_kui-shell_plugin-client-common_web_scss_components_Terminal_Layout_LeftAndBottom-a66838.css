/*!*********************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-client-common/web/scss/components/Terminal/Layout/LeftAndBottomComboStrips.scss ***!
  \*********************************************************************************************************************************************************************************************************/
/*
 ...
 * limitations under the License.
 */
.kui--tab-content[data-has-left-strip][data-has-bottom-strip] .kui--terminal-split-container[data-split-count="3"] {
  grid-template-rows: repeat(8, 1fr);
  grid-template-columns: repeat(4, 1fr);
  grid-template-areas: "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 B1 B1 B1";
}
.kui--tab-content[data-has-left-strip][data-has-bottom-strip] .kui--terminal-split-container[data-split-count="4"] {
  grid-template-rows: repeat(8, 1fr);
  grid-template-columns: repeat(4, 1fr);
  grid-template-areas: "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T1 T1 T1" "L1 T2 T2 T2" "L1 T2 T2 T2" "L1 T2 T2 T2" "L1 T2 T2 T2" "L1 B1 B1 B1";
}
.kui--tab-content[data-has-left-strip][data-has-bottom-strip] .kui--terminal-split-container[data-split-count="5"] {
  grid-template-rows: repeat(8, 1fr);
  grid-template-columns: repeat(8, 1fr);
  grid-template-areas: "L1 L1 T1 T1 T1 T2 T2 T2" "L1 L1 T1 T1 T1 T2 T2 T2" "L1 L1 T1 T1 T1 T2 T2 T2" "L1 L1 T3 T3 T3 T3 T3 T3" "L1 L1 T3 T3 T3 T3 T3 T3" "L1 L1 T3 T3 T3 T3 T3 T3" "L1 L1 T3 T3 T3 T3 T3 T3" "L1 L1 B1 B1 B1 B1 B1 B1";
}
