/*!**************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/@kui-shell/plugin-client-common/web/scss/components/Terminal/Experimental.scss ***!
  \**************************************************************************************************************************************************************************************/
/*
...
.kui--scrollback .kui--repl-block-experimental-tag-wrapper {
  margin: 0.3625em 0.5rem 0.3625em 0;
}
.kui--scrollback .kui--repl-block-experimental-tag .kui--tag,
.kui--scrollback .kui--repl-block-experimental-tag.kui--tag {
...
.kui--scrollback li.repl-block:focus .repl-input-element-wrapper {
  /** Notes: Tag Carbon impl is the former; PatternFly impl is the latter */
}
.kui--scrollback li.repl-block:focus .repl-input-element-wrapper .kui--repl-block-experimental-tag .kui--tag,
.kui--scrollback li.repl-block:focus .repl-input-element-wrapper .kui--repl-block-experimental-tag.kui--tag {
  opacity: 0;
  /* rather than display: none to avoid reflow on hover */
  transition-delay: 210ms;
}
.kui--scrollback li.repl-block:not(.repl-active) .repl-input-element-wrapper:hover {
  /** Notes: Tag Carbon impl is the former; PatternFly impl is the latter */
}
.kui--scrollback li.repl-block:not(.repl-active) .repl-input-element-wrapper:hover .kui--repl-block-experimental-tag .kui--tag,
.kui--scrollback li.repl-block:not(.repl-active) .repl-input-element-wrapper:hover .kui--repl-block-experimental-tag.kui--tag {
  opacity: 0;
  /* rather than display: none to avoid reflow on hover */
  transition-delay: 210ms;
